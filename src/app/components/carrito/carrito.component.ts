...
export class CarritoComponent implements OnInit {
  ...
  //=============Pagar Carrito==================================================
  pagarCarrito(){
    this.http.get('https://tienda-4abdd.firebaseio.com/productos/.json') //Realizar una consulta a la base de datos
  ...
  actualizarDisponible(id:number, itemCatalogo:Producto){
    return this.http.put(`https://tienda-4abdd.firebaseio.com/productos/${id}.json`, itemCatalogo) //Ejecutar el método put a la url de la base de datos enviando como parámetro el objeto Producto con su nuevos valores disponibles
    .map((response : Response) => {
